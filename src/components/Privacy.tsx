    ...
    <div className="min-h-screen bg-slate-50 py-12 px-6 font-sans">
      <div className="max-w-3xl mx-auto bg-white p-8 rounded-2xl shadow-sm border border-slate-100">
        ...
        <div className="prose prose-slate max-w-none text-slate-600">
          ...
          <h3 className="text-xl font-bold text-slate-900 mt-8 mb-4">3. Data Retention and Deletion</h3>
          <p className="mb-2">
            <strong>Retention:</strong> Because LunaFlow is a local-first application, we do not define a retention period for your data. Your data remains on your device and in your Google Drive until you choose to delete it.
          </p>
          <div className="mb-4">
            <strong>Deletion:</strong> You have full control over your data. You can delete your data at any time by:
            <ul className="list-disc pl-6 mt-2 space-y-1">
              <li>Clearing your browser's local storage or application data.</li>
              <li>Deleting the `lunaflow_data.json` file from the `LunaFlow` folder in your Google Drive.</li>
              <li>Revoking LunaFlow's access to your Google Drive via your <a href="https://myaccount.google.com/permissions" target="_blank" rel="noreferrer" className="text-rose-500 hover:underline">Google Account Permissions</a>.</li>
            </ul>
          </div>

          <h3 className="text-xl font-bold text-slate-900 mt-8 mb-4">4. Data Collection</h3>
          <p className="mb-4">
