...
import type { DailyRecord, FlowIntensity } from '../store/DailyRecord';
              ...
              {category.options.map((option) => {
                ...
                return (
                  <button
                    ...
                    className="px-3 py-1.5 rounded-full text-sm font-medium border-2 transition-all opacity-80 hover:opacity-100"
                    style={{
